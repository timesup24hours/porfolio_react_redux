...
class LoadingSignature extends Component {

  render() {
    return (
      <div className='LoadingSignature'>
        <svg version="1.1" id="wrapper" x="0px" y="0px"
         width="273px" height="125.2px" viewBox="0 0 273 125.2" enableBackground="new 0 0 273 125.2">

          <path className="LoadingSignature-path" fill="none" stroke="#000000" strokeWidth="4" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="
          ...
          <path fill="none" className="LoadingSignature-path2" stroke="#000000" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
...
export default LoadingSignature
